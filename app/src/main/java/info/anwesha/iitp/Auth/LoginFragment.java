...
public class LoginFragment extends Fragment {
    ...
    private void login() {
        ...
        Call<info.anwesha.iitp.Auth.LoginResponse> call = authApi.login(requestBody);

        call.enqueue(new Callback<info.anwesha.iitp.Auth.LoginResponse>() {
            @Override
            public void onResponse(@NonNull Call<info.anwesha.iitp.Auth.LoginResponse> call, @NonNull Response<info.anwesha.iitp.Auth.LoginResponse> response) {
            ...
            @Override
            public void onFailure(@NonNull Call<info.anwesha.iitp.Auth.LoginResponse> call, @NonNull Throwable t) {
                if (progressDialog != null) progressDialog.dismiss();

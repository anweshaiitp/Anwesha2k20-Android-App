...
public class MainActivity extends AppCompatActivity implements EventsRecyclerAdapter.OnEventSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                ...
                R.id.nav_gallery, R.id.nav_team, R.id.nav_sponsors, R.id.nav_maps, R.id.nav_developers, R.id.nav_account, R.id.nav_accomodation,R.id.option_contact, R.id.nav_event_schedule)
